...
Because statistics inherently depends on mathematics, it is very important to get a reasonably formal introduction to the topic. The usual, informal manner in which statistics is taught has been a failure in all Cognitive Science disciplines.  We see this in the way statistics is routinely abused in psycholinguistics, psychology, and linguistics, among other areas. Some examples from psycholinguistics are mentioned alongside each point: 
...
If you find mistakes, please open an issue [here](https://github.com/vasishth/BayesianLinearModeling). Alternatively, if you know to, you can alternatively [fork and make a pull request](https://help.github.com/articles/fork-a-repo/).
...
This is why it is so important to expend some energy in understanding these concepts. One common question I get is: *why do I need to know this*? The answer is: Please trust me that you do.
...
This presentation is adapted from https://github.com/wzchen/probability_cheatsheet.
