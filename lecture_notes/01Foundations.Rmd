...
Yet, most people do not make these mistakes intentionally; I know because I have made them too. For examples of mistakes listed above from my own work, see @vasishthlewisLanguage05, @vasishth:phdbook. 


In a modest attempt to at least partly remedy this situation, the present course attempts to provide some understanding of the basic ideas behind statistical modeling. 

One important caveat here is that my own understanding is imperfect; I have studied these topics formally (MSc Statistics, Sheffield, UK), but that doesn't mean I grasp them fully. For deeper study, I recommend going to a Statistics or Math department and learning from professionals there. Meanwhile, if you find mistakes, please open an issue here: https://github.com/vasishth/BayesianLinearModeling. 

I assume here that the graduate student taking this course has elementary numeracy acquired usually at the class 10 level. I generally avoid calculus and linear algebra, and do not require the student to know these topics. Whenever these topics come up, I will explain them just in time. What I do assume is basic algebra, set theory,  and arithmetic ability.
...
The basic idea we will explore in this course is: how to 
use Bayes' theorem for data analysis. In order to understand the methodology, some passive understanding of the following concepts needs to be in place:
...
Without a clear understanding of these concepts, it is difficult to figure out how statistical modeling works. 

So we will begin with these concepts. But before we dive in, it may help to know where we are going.
...
The above is what you will learn in this course; all the terms introduced above will be explained in these notes. We begin with basic probability theory.

## Brief review of probability theory

The best reference textbook I know for s first contact with probability theory is @kerns. My notes below are a bit terse because I am assuming you will look at Kerns if something is unclear.
